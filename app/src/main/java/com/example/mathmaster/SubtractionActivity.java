            ...
            builder.setTitle("Game Over!")
                    ...
                    .setPositiveButton("Go To Home", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            if (score > 0) {
                                insertStreakNote(new StreakEntity(UUID.randomUUID().toString(), score, "Subtraction", System.currentTimeMillis()), false);
                            } else {
                                onBackPressed();
                            }
                            dialog.dismiss();
                    ...
                    .setNegativeButton("Play Again", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int i) {
                            if (score > 0) {
                                insertStreakNote(new StreakEntity(UUID.randomUUID().toString(), score, "Subtraction", System.currentTimeMillis()), true);
                            }
                            dialog.dismiss();
                        }
                    });
            ...
            public void subscribe(@NonNull ObservableEmitter<String> e) throws Exception {
                ...
                .subscribe(new Consumer<String>() {
                    ...
                    public void accept(Throwable throwable) throws Exception {
                        Toast.makeText(getBaseContext(), "Error with insertion in database at Subtraction", Toast.LENGTH_LONG).show();
